...
public class EventController
{
    ...
    public ChoiceBox<String> choiceBoxWorker;
    ...
    public void initialize()
    {
        ...
        var workersName = WorkersController.getWorkersInfo("name");
        ...
        choiceBoxWorker.getItems().addAll( workers );
        worker = "";
        date = null;
    }
    ...
    {
        if( textArea.getText().equals("") || choiceBoxE.getValue() == null || choiceBoxS.getValue() == null || choiceBoxWorker == null)
            return;
